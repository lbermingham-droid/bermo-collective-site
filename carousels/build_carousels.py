...
/* gap scan flag rows (post 2, replicates the real report's flag system) */
.sflags{padding:44px 48px;}
.sf-row{display:flex;align-items:center;gap:22px;border-bottom:1px solid #ececea;padding:26px 2px;}
.sf-row:last-child{border-bottom:none;}
.sf-flag{font:800 16px 'Barlow Condensed',sans-serif;letter-spacing:1.5px;padding:10px 0;width:118px;text-align:center;text-transform:uppercase;flex-shrink:0;}
.sf-area{font:800 26px 'Inter Tight',sans-serif;color:var(--ink);width:300px;flex-shrink:0;text-align:left;}
.sf-why{font:500 20px/1.4 'Inter',sans-serif;color:rgba(10,10,10,0.65);flex:1;text-align:left;}
.sf-note{margin-top:22px;font:600 19px 'Inter',sans-serif;color:var(--ink);text-align:left;}
...
SCANFLAGS = """<div class="ui card-w sflags">
  <div class="uihead"><span class="t">Your Gap Scan &middot; ranked by expected return</span><span class="utag cy">28 untapped opportunities</span></div>
  <div class="sf-row"><span class="sf-flag" style="background:#0a0a0a;color:#00f5d4;">High-ROI</span><span class="sf-area">AI answer visibility</span><span class="sf-why">69% of buyers pick a different vendor after an AI answer.</span></div>
  <div class="sf-row"><span class="sf-flag" style="background:#c8f500;color:#0a0a0a;">Quick fix</span><span class="sf-area">Structured markup</span><span class="sf-why">A fast add that pulls you into the right answers, days not weeks.</span></div>
  <div class="sf-row"><span class="sf-flag" style="background:#ff2d7a;color:#fff;">Priority</span><span class="sf-area">Buyer language messaging</span><span class="sf-why">Framing around the buyer's own metrics makes the case land.</span></div>
  <div class="sf-row"><span class="sf-flag" style="background:#00f5d4;color:#0a0a0a;">Strong</span><span class="sf-area">Track record and proof</span><span class="sf-why">Real credibility buyers reward, once it is made visible.</span></div>
  <div class="sf-note">Every flag marks the kind of move it is, ranked by expected return.</div>
</div>"""
...
WHYBOARD = """<div class="ui card-w whyb">
  ...
  <div class="whyb-row">
    ...
    <span class="utag am">28 opportunities</span>
  </div>
  <div class="whyb-row">
