...
GLOWBOX = f"""<div class="ui glowbox">
  <div class="gb-mascot">{MASCOT}</div>
...
posts["post-1-who-is-bermo.html"] = page(
 ...
 [
  slide("mint", f"""
     <h1 style="font-size:104px;letter-spacing:-3px;">Who is BERMO.?</h1>
     <h2 style="font-size:47px;line-height:1.22;letter-spacing:-1px;margin-top:-6px;">Imagine a team that knew what your growth needed next, and had it handled before you even added it to your list.</h2>
