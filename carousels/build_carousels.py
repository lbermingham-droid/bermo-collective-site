...
posts["post-1-who-is-bermo.html"] = page(
 ...
 [
  slide("mint", f"""
     <div class="kicker">Who is BERMO.?</div>
     <h1 style="font-size:72px;">Imagine a team that knew what your growth needed next, and had it handled before you even added it to your list.</h1>
     {SHADOWCHAT}""", 1, 6, cover=True),
  slide("mint", f"""
